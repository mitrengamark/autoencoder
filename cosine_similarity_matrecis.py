...
selected_vae_dirs = ["bmw_model_tesla_data", "tesla_model_bmw_data", "bmw_OG_remake", "OG_remake"]  # Válaszd ki a kívánt VAE mappákat, vagy hagyd üresen az összeshez
...
for vae in vae_dirs:
    ...
    cos_sim = CosineSimilarity(average_dir, save_dir, threshold=99)
